...
exports.default = {
  ...
  computed: {
    ...
    pages_nums: function pages_nums() {
      var arr = [];
  ...
  actions: {
    ...
    filterUpdate: function filterUpdate(context) {
      ...
      if (context.state.sort_order == 'za') {
        query = query.OrderByDescending(function (o) {
          return o[context.state.sort_by];
        });
      } else {
        query = query.OrderBy(function (o) {
          return o[context.state.sort_by];
        });
      }
